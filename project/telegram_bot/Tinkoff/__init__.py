...
class TinkoffSimplePayment(TinkoffBase):
    ...
    def init(self, order_id, amount, ip=None, description=None, currency=None, language=None,
             customer_key=None, recurrent=False, redirect_due_date=None, data=None, receipt=None, sign_request=False, notificationURL=None):
        ...
        if notificationURL:
            request_data['NotificationURL'] = notificationURL
